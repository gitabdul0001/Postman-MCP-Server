/**
 * Function to perform a nearby search for places using the Google Maps API.
 *
 ...
 * @param {string} [args.keyword] - The text string on which to search, e.g., "restaurant".
...
/**
 * Tool configuration for performing a nearby search using the Google Maps API.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'nearby_search',
      description: 'Perform a nearby search for places using the Google Maps API.',
      parameters: {
        type: 'object',
        properties: {
          location: {
          ...
          keyword: {
            type: 'string',
            description: 'The text string on which to search, e.g., "restaurant".'
          },
          name: {
            type: 'string',
