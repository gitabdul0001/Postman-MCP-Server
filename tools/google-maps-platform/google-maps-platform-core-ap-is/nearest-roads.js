/**
 * Function to find the nearest road segments for a given set of GPS coordinates using the Google Roads API.
 *
 * @param {Object} args - Arguments for the nearest roads function.
 ...
 *                                For example: "60.170880,24.942795|60.170879,24.942796".
...
/**
 * Tool configuration for finding nearest roads using the Google Roads API.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'nearest_roads',
      description: 'Find the nearest road segments for a given set of GPS coordinates.',
      parameters: {
        type: 'object',
        properties: {
          points: {
