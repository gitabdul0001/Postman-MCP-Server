 ...
 * @param {number} args.latitude - The latitude of the location for the forecast.
 * @param {number} args.longitude - The longitude of the location for the forecast.
 * @param {string} [args.unitsSystem='METRIC'] - The units system for the weather conditions.
 * @param {number} [args.pageSize=24] - The maximum number of hourly forecast records to return.
 ...
 * @returns {Promise<Object>} - The result of the hourly weather forecast.
 */
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          latitude: {
            type: 'number',
            description: 'The latitude of the location for the forecast.'
          },
          longitude: {
            type: 'number',
            description: 'The longitude of the location for the forecast.'
          },
          unitsSystem: {
            type: 'string',
          ...
          pageSize: {
            type: 'integer',
            description: 'The maximum number of hourly forecast records to return.'
          },
          pageToken: {
            type: 'string',
