/**
 * Function to get the daily weather forecast based on location coordinates.
 *
 ...
 * @returns {Promise<Object>} - The result of the forecast lookup.
 */
...
/**
 * Tool configuration for fetching daily weather forecasts.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'forecast_days',
      description: 'Get the daily weather forecast based on location coordinates.',
      parameters: {
        type: 'object',
        properties: {
          latitude: {
