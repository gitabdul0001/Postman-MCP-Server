 ...
 * @param {string} [args.unitsSystem='METRIC'] - The units system to use for the returned weather conditions (default is METRIC).
 * @param {string} [args.languageCode='en'] - The language for the response (default is English).
