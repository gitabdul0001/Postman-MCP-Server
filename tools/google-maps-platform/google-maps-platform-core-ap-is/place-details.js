 ...
 * @param {string} [args.region] - The region code for the request.
 * @returns {Promise<Object>} - The result of the place details request.
 */
const executeFunction = async ({ place_id, fields, sessiontoken, language = 'en', region }) => {
...
/**
 * Tool configuration for getting place details from the Google Places API.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'Get details about a specific place from the Google Places API.',
      parameters: {
        type: 'object',
        properties: {
          place_id: {
